...
/**
 * Chaser Game
 * <p>An Emoji face eats food with music playing in the background </p>
 * @author Kacie Rae
 * <p> Date: 5-17-19 </p>
 * Final Project Chaser Game extends Application
 */
...
public class FinalProjectChaserGame extends Application {
	...
	/**
	 * This is the main method which makes use of pointsGain, and playMediaTracks.  
	 * @param args unused
	 * @return void
	...
	/**
	 * method that holds all GUI setup
	 * @param Stage
	 * @return void
	...
	/**
	 * method that add points when the face touches the food.
	 * It makes use of die from Food and it gets x and y of food and face.
	 * @return void
...
/**
 * Chaser class that creates face object, extends Pane.
 */
class Chaser extends Pane {
	...
	/**
	 * method that moves face down when called
	 * @return void  
	 */
	public void down(){
	...
	/**
	 * method that moves face up when called
	 * @return void
	 */
	public void up(){
	...
	/**
	 * method that moves face right when called
	 * @return void
	 */
	public void right(){
	...
	/**
	 * method that moves face left when called
	 * @return void
	 */
	public void left(){
	...
	/**
	 * method that moves face to origin to restart
	 * @return void
	 * @exception FileNotFoundException 
	 */
	public void start(){
	...
	/**
	 * method that moves makes use of start and and sets score to 0.
	 * @return void 
	 */
	public void restart(){
		this.scoreT = 0;
...
/**
 * Food class that creates food object, extends Pane.
 */
class Food extends Pane {
	...
	/**
	 * method that moves food randomly while using foodPicker
	 * @return void 
	...
	/**
	 * method that uses start to move food around when called
	 * @return void
	 */
	public void restart(){
	...
	/**
	 * method that deletes food when eaten and makes new food to replace it
	 * @return void
	 * @exception FileNotFoundException 
	 * @exception NullPointerException
	 */
	...
	/**
	 * method that chooses file to make a random food image
	 * @return String
	 * @exception FileNotFoundException 
	 */
	public static String foodPicker() {
		...
		String[] food  = {"banana", "birthdayCake", "bread", "candy", "cherry", "chocolate", 
				...
				"grapes", "greenApple", "greenSoup", "hamburger", "honey", "icecreamBowl", "icecreamCone", 
				"lemon", "lollypop", "meatOnBones", "meatShishkabob", "melon", "orange", "orangeJuice", "peach",
				"pear", "pineapple", "pizzaSlice", "redApple", "rice", "spaghetti","strawberry",
				"strawberryIcecream", "strawberryShortCake", "tomato", "watermelonSlice", "yams" };
